...
// Import screens
import SimpleRoleSelection from './src/screens/SimpleRoleSelection';
import SimpleLogin from './src/screens/SimpleLogin';
import SimplePilgrimDashboard from './src/screens/SimplePilgrimDashboard';
import SimpleVolunteerDashboard from './src/screens/SimpleVolunteerDashboard';
    ...
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen 
          ...
          component={SimplePilgrimDashboard} 
          options={{ title: 'ShaktiAI - Pilgrim', headerLeft: () => null }}
        />
        <Stack.Screen 
          name="VolunteerDashboard" 
          component={SimpleVolunteerDashboard} 
